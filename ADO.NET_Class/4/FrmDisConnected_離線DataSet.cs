...
namespace Starter
{
    public partial class FrmDisConnected_離線DataSet : Form
    {
        ...
        private void Button28_Click(object sender, EventArgs e)
        {
            ...
            this.dataGridView7.Rows[1].Frozen = true;
        }
        ...
        private void dataGridView7_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                int ProductID = (int)this.dataGridView7.Rows[e.RowIndex].Cells["ProductID"].Value;
                MessageBox.Show("Product Details ProductID=" + ProductID);
        ...
        {
            this.productsTableAdapter1.Update(this.nwDataSet1.Products);
            //this.nwDataSet1.Products.AcceptChanges();
        }
    }
}
